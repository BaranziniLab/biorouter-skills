---
name: biomedical-imaging-pathology
description: Plan biomedical imaging workflows across DICOM, pathology slides, PACS metadata, PathML/histolab-style tiling, image QC, cohort metadata, and privacy-safe reporting.
user-invocable: true
license: Apache-2.0
---

# Biomedical Imaging and Pathology
...
Use this skill when the user asks for Imaging. Load more specific BioSkills, BRXT extensions, or language skills when the task touches a concrete dataset, file format, package, or platform.
