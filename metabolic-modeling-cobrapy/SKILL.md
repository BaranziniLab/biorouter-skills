---
name: metabolic-modeling-cobrapy
description: Guide constraint-based metabolic modeling with COBRApy, flux balance analysis, gene-protein-reaction rules, media constraints, knockouts, objective functions, and model provenance. Use when users ask about genome-scale metabolic models or flux predictions.
user-invocable: true
license: Apache-2.0
---
...
Use this skill when the user asks about genome-scale metabolic models, flux predictions, knockouts, media constraints, or pathway objectives. Prefer the most specific BioRouter extension, BioSkill, or language style skill whenever a concrete platform, package, or file type appears.
