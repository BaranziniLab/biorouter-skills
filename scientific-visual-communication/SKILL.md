...
description: Plan scientific schematics, infographics, posters, slides, figure panels, Mermaid diagrams, and visual abstracts with source-to-visual traceability. Use when users need a visual explanation, figure plan, poster, slide deck, schematic, or graphical abstract.
user-invocable: true
license: Apache-2.0
---
...
Use this skill when the user asks about scientific schematics, posters, slides, figure panels, visual abstracts, or graphical explanations. Prefer the most specific BioRouter extension, BioSkill, or language style skill whenever a concrete platform, package, or file type appears.
