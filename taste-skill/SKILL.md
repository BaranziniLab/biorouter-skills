---
name: taste-skill
description: Anti-slop frontend skill for landing pages, portfolios, and redesigns. The agent reads the brief, infers the right design direction, and ships interfaces that do not look templated. Real design systems when applicable, audit-first on redesigns, strict pre-flight check. Use when building or restyling a web UI, dashboard, lab tool, or paper companion site.
license: Apache-2.0
---

<!-- Adapted from Leonxlnx/taste-skill (https://github.com/Leonxlnx/taste-skill), MIT License. -->
