---
name: regulatory-quality-systems
description: Review scientific software, medical-device, and lab-process work against ISO 13485-style quality systems, design controls, validation evidence, traceability, and risk management. Use when tasks mention regulatory readiness, quality management, validation, design controls, or audit trails.
user-invocable: true
license: Apache-2.0
---
...
Use this skill when the user asks about regulatory readiness, quality management, ISO 13485, validation, design controls, or audit trails. Prefer the most specific BioRouter extension, BioSkill, or language style skill whenever a concrete platform, package, or file type appears.
