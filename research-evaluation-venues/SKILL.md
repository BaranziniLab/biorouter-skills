---
name: research-evaluation-venues
description: Evaluate papers, scholars, venues, impact claims, publication fit, reviewer expectations, and research positioning without overclaiming bibliometrics. Use when users ask where to submit, how strong a paper is, or how to evaluate a scholar/topic.
user-invocable: true
license: Apache-2.0
---

# Research Evaluation and Venues
...
Use this skill when the user asks about publication venues, paper strength, scholar evaluation, impact claims, reviewer expectations, or research positioning. Prefer the most specific BioRouter extension, BioSkill, or language style skill whenever a concrete platform, package, or file type appears.
