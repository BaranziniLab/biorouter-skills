...
description: Plan safe lab-automation workflows for Opentrons, cloud labs, Ginkgo-style APIs, plate maps, run metadata, and protocol simulation. Use when a request involves robots, wet-lab run planning, samples, plates, liquid handling, or cloud-lab execution.
user-invocable: true
license: Apache-2.0
---
...
Use this skill when the user asks for Lab Automation. Load more specific BioSkills, BRXT extensions, or language skills when the task touches a concrete dataset, file format, package, or platform.
