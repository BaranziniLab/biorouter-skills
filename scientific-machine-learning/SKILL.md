...
description: Plan scientific ML workflows with scikit-learn, PyTorch Lightning, transformers, graph neural networks, active learning, SHAP/explainability, and leakage checks. Use when applying ML to biomedical, materials, chemistry, imaging, or other scientific datasets.
user-invocable: true
license: Apache-2.0
---
...
Use this skill when the user asks for Scientific ML. Load more specific BioSkills, BRXT extensions, or language skills when the task touches a concrete dataset, file format, package, or platform.
