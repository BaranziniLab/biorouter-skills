...
description: Plan analysis for biosignals and neural recordings: ECG/EDA/PPG with NeuroKit2, spike sorting/Neuropixels metadata, peri-event analysis, quality control, and reproducible signal-processing pipelines.
user-invocable: true
license: Apache-2.0
---
...
Use this skill when the user asks for Neurophysiology. Load more specific BioSkills, BRXT extensions, or language skills when the task touches a concrete dataset, file format, package, or platform.
