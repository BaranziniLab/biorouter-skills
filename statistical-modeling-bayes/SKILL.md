---
name: statistical-modeling-bayes
description: Design and critique statistical models with statsmodels, PyMC, survival models, hierarchical models, power analysis, posterior predictive checks, and uncertainty reporting. Use when a request needs principled statistical modeling rather than a generic machine-learning fit.
user-invocable: true
license: Apache-2.0
---

# Statistical Modeling and Bayes
...
Use this skill when the user asks for Statistics. Load more specific BioSkills, BRXT extensions, or language skills when the task touches a concrete dataset, file format, package, or platform.
