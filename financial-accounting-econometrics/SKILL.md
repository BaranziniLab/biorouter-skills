---
name: financial-accounting-econometrics
description: Plan empirical finance/accounting workflows with Compustat/CRSP-style panels, event studies, abnormal returns, clustering, fixed effects, disclosure measures, and table replication. Use for accounting, finance, corporate, or market-data empirical research.
user-invocable: true
license: Apache-2.0
---

# Financial and Accounting Econometrics
...
Use this skill when the user asks about accounting, finance, corporate disclosure, event studies, abnormal returns, CRSP/Compustat-style panels, or market data. Prefer the most specific BioRouter extension, BioSkill, or language style skill whenever a concrete platform, package, or file type appears.
