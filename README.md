...
| [`stata-research-workbench`](stata-research-workbench) | `/stata-research-workbench` | Plans Stata `.do`/`.dta` research workflows: audits, logs, tables, graph export, replication, and R&R updates. |
| [`survey-weights-complex-samples`](survey-weights-complex-samples) | `/survey-weights-complex-samples` | Handles complex survey designs with strata, PSUs, replicate weights, domain analysis, calibration, and weighted inference. |
| [`psychometrics-sem-measurement`](psychometrics-sem-measurement) | `/psychometrics-sem-measurement` | Plans reliability, CFA/SEM, mediation/moderation, invariance, item analysis, and APA-style measurement reporting. |
| [`social-science-text-as-data`](social-science-text-as-data) | `/social-science-text-as-data` | Plans dictionaries, topic models, embeddings, sentiment, supervised coding, LLM-label validation, and measurement-error checks. |
| [`econ-finance-data-sources`](econ-finance-data-sources) | `/econ-finance-data-sources` | Routes empirical econ/finance sources including WRDS, CRSP, Compustat, SEC/EDGAR, NBER, SSRN, and public datasets. |
| [`empirical-paper-submission-rr`](empirical-paper-submission-rr) | `/empirical-paper-submission-rr` | Plans journal targeting, referee reports, response letters, revise-and-resubmit execution, and appendix organization. |
| [`structural-economics-theory`](structural-economics-theory) | `/structural-economics-theory` | Routes game theory, equilibrium, DSGE/HANK, structural IO, calibration, simulation, and identification-proof workflows. |
| [`causal-heterogeneity-policy-learning`](causal-heterogeneity-policy-learning) | `/causal-heterogeneity-policy-learning` | Plans CATE, causal forests, meta-learners, policy learning, conformal causal inference, fairness, and subgroup reporting. |
| [`arbor-optimization`](arbor-optimization) | `/arbor-optimization` | Runs evaluator-driven branch-and-prune exploration for improving research artifacts, prompts, analyses, and designs. |
| [`hugging-science-resource-discovery`](hugging-science-resource-discovery) | `/hugging-science-resource-discovery` | Finds and evaluates Hugging Face scientific models, datasets, Spaces, and papers with license, provenance, and benchmark checks. |
| [`molecular-dynamics`](molecular-dynamics) | `/molecular-dynamics` | Plans MD setup and trajectory analysis with OpenMM, GROMACS, AmberTools, MDAnalysis, MDTraj, and reproducibility checks. |
| [`general-time-series-forecasting`](general-time-series-forecasting) | `/general-time-series-forecasting` | Plans non-omics forecasting with classical models, ML, foundation models, backtesting, leakage checks, and uncertainty. |
| [`bids-neuroimaging`](bids-neuroimaging) | `/bids-neuroimaging` | Audits BIDS neuroimaging datasets, derivatives, validation, metadata, and reproducible preprocessing readiness. |
| [`clinical-ai-modeling`](clinical-ai-modeling) | `/clinical-ai-modeling` | Plans clinical AI modeling workflows with EHR cohorts, validation, bias checks, calibration, safety, and no-PHI handling. |
| [`computational-fluid-dynamics`](computational-fluid-dynamics) | `/computational-fluid-dynamics` | Plans CFD workflows with meshes, boundary conditions, turbulence models, solver validation, and convergence checks. |
...
| [`autoskill-workflow-discovery`](autoskill-workflow-discovery) | `/autoskill-workflow-discovery` | Detects repeated workflows and drafts native BioRouter skills, hooks, checklist updates, or extension plans. |
...
| `stata-research-workbench`, `survey-weights-complex-samples`, `psychometrics-sem-measurement`, `social-science-text-as-data`, `econ-finance-data-sources`, `empirical-paper-submission-rr`, `structural-economics-theory`, `causal-heterogeneity-policy-learning` | Lab-original synthesis inspired by [brycewang-stanford/Auto-Empirical-Research-Skills](https://github.com/brycewang-stanford/Auto-Empirical-Research-Skills) | Apache-2.0 | Rewritten as native BioRouter empirical/social-science workbench skills. No upstream text copied. |
| `autoskill-workflow-discovery`, `arbor-optimization`, `hugging-science-resource-discovery`, `molecular-dynamics`, `general-time-series-forecasting`, `bids-neuroimaging`, `clinical-ai-modeling`, `computational-fluid-dynamics` | Lab-original capability-cluster synthesis inspired by [k-dense-ai/scientific-agent-skills](https://github.com/k-dense-ai/scientific-agent-skills) | Apache-2.0 | Rewritten as native BioRouter skills for workflow discovery, evaluator optimization, scientific resource discovery, molecular dynamics, forecasting, BIDS neuroimaging, clinical AI modeling, and computational fluid dynamics. No upstream text copied. |
