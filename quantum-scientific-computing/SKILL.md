...
description: Route and review quantum/scientific simulation work using Qiskit, Cirq, PennyLane, QuTiP, variational circuits, quantum chemistry, and simulation validation. Use when a task mentions quantum circuits, quantum ML, Hamiltonians, or open quantum systems.
user-invocable: true
license: Apache-2.0
---
...
Use this skill when the user asks for Quantum. Load more specific BioSkills, BRXT extensions, or language skills when the task touches a concrete dataset, file format, package, or platform.
