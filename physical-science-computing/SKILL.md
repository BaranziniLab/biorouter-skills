...
Use this skill when the user asks about astronomy, physics, physical chemistry, units, coordinate transforms, spectra, or numerical experiments. Prefer the most specific BioRouter extension, BioSkill, or language style skill whenever a concrete platform, package, or file type appears.
