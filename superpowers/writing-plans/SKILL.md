...
**2. Placeholder scan:** Search your plan for "TBD", "TODO", incomplete sections, or vague steps. Fix them.
...
**1. Subagent-Driven (recommended)** - Dispatch a fresh subagent per task, review between tasks, fast iteration (follow the subagent-driven-development skill)

**2. Inline Execution** - Execute tasks in this session with checkpoints (follow the executing-plans skill)
