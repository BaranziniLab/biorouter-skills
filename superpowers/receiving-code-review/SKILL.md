...
When replying to inline review comments on GitHub, reply in the comment thread using `gh api repos/{owner}/{repo}/pulls/{pr}/comments/{id}/replies`, not as a top-level PR comment.
