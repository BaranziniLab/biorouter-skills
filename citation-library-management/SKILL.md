...
description: Use Zotero, DOI/PMID lookup, Crossref/OpenAlex, MarkItDown, and citation-file hygiene to build, clean, and verify reference libraries and bibliographies. Use when the user asks for Zotero, BibTeX, RIS, CSL, citation cleanup, or source-library deduplication.
user-invocable: true
license: Apache-2.0
---
...
Use this skill when the user asks for Citations. Load more specific BioSkills, BRXT extensions, or language skills when the task touches a concrete dataset, file format, package, or platform.
